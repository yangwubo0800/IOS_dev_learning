...
{
    NSLog(@"=====_progressView is %p", _progressView);
    if (!_progressView){
...
//        [_webView loadHTMLString:htmlString baseURL:[NSURL fileURLWithPath:[[NSBundle mainBundle] bundlePath]]];
        ...
        // 2.创建URL
//        NSURL *url = [NSURL URLWithString:@"http://m.electro.hnaccloud.com"];
//        // 3.创建Request
//        NSURLRequest *request =[NSURLRequest requestWithURL:url];
//        // 4.加载网页
//        [_webView loadRequest:request];
        ...
        NSString *htmlPath = [[NSBundle mainBundle] pathForResource:@"test.html" ofType:nil inDirectory:@"Resource"];
